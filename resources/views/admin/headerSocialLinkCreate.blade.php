    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{trans('admin.Add Social Link')}}</h1>
            </div>
                        ...
                        <form action="{{route('admin.social-link.store')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <label class="custom-switch pl-0 mt-2">
                                    <input type="checkbox" name="on_header" class="custom-switch-input">
                            ...
                            <div class="form-group">
                                ...
                                <label class="custom-switch pl-0 mt-2">
                                    <input type="checkbox" name="on_footer" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">{{trans('admin.OFF')}} / {{trans('admin.ON')}}</span>
                                </label>
                            </div>
