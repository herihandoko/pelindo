@php
$page_title = trans('admin.Admin | Add statistics item');
@endphp
@push('style')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{trans('admin.Add Statistics Item')}}</h1>
            </div>
            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.statistic-item.store')}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control h-100" name="subtitle" rows="3" required></textarea>
                            </div>
                            <div class="form-group">
