                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2 class="title text-capitalize">{{trans('frontend.Blog Category')}} - {{request()->segment(3)}}</h2>
                                <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
                                    <div class="breadcrumbs">
                                        ...
                                        <span><i class="fa fa-angle-right"></i></span>
                                        <span class="active">{{trans('frontend.Category')}}</span>
                                        <span><i class="fa fa-angle-right"></i></span>
                                        <span class="active">{{request()->segment(3)}}</span>
                                    </div>
                                </nav>
                            </div>
                        </div>
