                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2 class="title text-capitalize">{{trans('frontend.Search')}} - {{request()->get('query')}}</h2>
                                <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
                                    <div class="breadcrumbs">
                                        ...
                                        <span><i class="fa fa-angle-right"></i></span>
                                        <span class="active">{{trans('frontend.Search')}}</span>
                                        <span><i class="fa fa-angle-right"></i></span>
                                        <span class="active">{{request()->get('query')}}</span>
                                    </div>
                                </nav>
                            </div>
                        </div>
