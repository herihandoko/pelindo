    ...
    <div id="wrapper" class="clearfix">
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2 class="title">{{trans('frontend.Blogs')}}</h2>
                                            ...
                                            <div class="col">
                                                <div class="entry-header">
                                                    <div class="post-thumb thumb">
                                                        <img src="{{asset(MediaImage($item->image, 1))}}"
                                                ...
                                                <div class="entry-content p-10">
                                                    ...
                                                    <div class="entry-meta">
                                                        ...
                                                        <span class="mb-10 text-gray-darkgray mr-10 font-size-13"><i
                                                            ...
                                                            {{$item->comments()->where(['status' => 1])->count()}}
                            ...
                            <div class="sidebar sidebar-left mt-sm-30">
                                <div class="widget">
                                    <h4 class="widget-title widget-title-line-bottom line-bottom-theme-colored1">
                                        {{trans('frontend.Search Box')}}</h4>
                                    <form role="search" method="get" class="search-form"
                                        action="{{route('blog_search')}}">
                                        <input type="search" class="form-control search-field" placeholder="Search &hellip;"
                                            value="" name="query" />
        ...
        as $item)
                                ...
                                <div class="widget widget_archive">
                                    <h4 class="widget-title widget-title-line-bottom line-bottom-theme-colored1">
                                        {{trans('frontend.Archive')}}
                                    </h4>
                                    <ul>
                                        @foreach (showArchive() as $date => $post)
                                            <li><a
                                                    href='{{route('blog_archive', ['range' => $date])}}'>{{Carbon\Carbon::parse($date)->format('Y F')}}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
