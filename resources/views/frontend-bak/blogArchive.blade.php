                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2 class="title">{{trans('frontend.Archive')}} - {{Carbon\Carbon::parse(request()->segment(3))->format('F Y')}}</h2>
                                <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
                                    <div class="breadcrumbs">
                                        ...
                                        <span><i class="fa fa-angle-right"></i></span>
                                        <span class="active">{{trans('frontend.Archive')}}</span>
                                        <span><i class="fa fa-angle-right"></i></span>
                                        <span class="active">{{Carbon\Carbon::parse(request()->segment(3))->format('F Y')}}</span>
                                    </div>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="sidebar sidebar-left mt-sm-30">
                                <div class="widget">
                                  ...
                                  <form role="search" method="get" class="search-form" action="{{route('blog_search')}}">
                                    <input type="search" class="form-control search-field" placeholder="{{trans('frontend.Search')}} &hellip;" value="" name="query"/>
