                ...
                <rs-module id="rev_slider_1_1" data-version="6.3.3">
                    <rs-slides>
                        @foreach (@App\Models\Slider::all() as $item)
                            <rs-slide data-key="rs-{{$item->id}}" data-title="Slide {{$loop->iteration}}"
                                data-thumb="{{MediaImage($item->image, 1)}}"
                                data-anim="ei:d;eo:d;s:d;r:default;t:slotslide-horizontal;sl:d;">
                                <img src="{{MediaImage($item->image, 1)}}" alt="{{getAlterTag($item->image)}}" title="firoox-s1" width="1920"
                                ...
                                <rs-layer id="slider-2-slide-2-layer-22" data-type="text" data-rsp_ch="on"
                                    ...
                                    data-frame_999="o:0;st:w;sR:6300;" class="font-current-theme1"><a
                                        href="{{$item->button_link}}"
                                        class="btn btn-theme-colored1">{{$item->button}}</a>
                                </rs-layer>
